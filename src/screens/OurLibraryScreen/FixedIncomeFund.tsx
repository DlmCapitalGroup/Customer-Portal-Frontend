...
const FixedIncomeFund = (props: _props) => {
    ...
    const [formData, setFormData]: any = useState({
        instrumentTypeName: "0000000001", // Instrument code

        instrumentTypeLabel: "ZANIBAL SOLUTIONS FIXED DEPOSIT",
    ...
    //             faceValue: formData.investmentAmount,

    //             currentRate: formData.investmentRate,
    ...
    const openAccount = async () => {
        ...
        var config = {
            method: "post",
            maxBodyLength: Infinity,
            url: "https://zas-dev.zanibal.com/api/v1/order/terminstrument/submit",
            data: formData,
        };

        const res = await devInstance(config)
            .then(function (response: any) {
                console.log(JSON.stringify(response.data));
                toast.success(`${response.message || response.data.message}`);
                dispatch(clearStepper());
    ...
    return (
        ...
        >
            <div className="text-primary">
                {/* {{
                    instrumentTypeName: "0000000001",
                    instrumentTypeLabel: "ZANIBAL SOLUTIONS FIXED DEPOSIT",
                    customerId: 454594,
                    startDate: "2023-06-16T14:15:22Z",
                    tenure: 270,
                    currency: "NGN",
                    faceValue: 20000,
                    currentRate: 7,
