                    ...
                    <nav>
                        <div className="container max-w-[1440px] flex items-center justify-between lg:px-10 px-5 py-10">
                            ...
                            <div className="flex items-center gap-x-10 text-[18px] font-semibold">
                                ...
                                <a href="/auth/sign-in" className="cursor-pointer">
                                    Sign In
                                </a>
                                <Button
                                    buttonType="md"
                    ...
                    >
                        ...
                        <div className="bg-[#E1E6EA] grow min-h-[574px] py-10 shadow-xl rounded-lg">
                            <div className="mx-auto max-w-[566px] flex flex-col gap-y-5">
                                <Input placeholder="Full Name" value={contactForm.fullname}  onChange={(e: any) => setContactForm({
                                        ...contactForm,
                                ...
                                <textarea
                                    ...
                                    required
                                ></textarea>
                                <Button onClick={() => contactFormAction()} buttonType="full">{cLoading ? "Please wait..." : "Submit"}</Button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-[1440px] container px-10 py-10">
                            ...
                            <div className="flex items-center gap-x-4">
                                <div className="-mt-2 w-full">
                                    <Input
                                        ...
                                        type="email"
                                        value={newsLetter}
                                        onChange={(e: any) => setNewsLetter(e.target.value)}
                                        required
                                    />
                                </div>
                                <Button onClick={() => newsLetterFormAction()} buttonType="md">
                        ...
                        <div className="grid grid-cols-3 my-[100px]">
                            <div className="flex flex-col gap-y-4 w-fit">
                                ...
                                <a href="/auth/sign-up" className="text-lg cursor-pointer">Sign Up</a>
                                <a href="/auth/sign-in" className="text-lg cursor-pointer">Sign In</a>
                            </div>
                            <div className="flex flex-col gap-y-4 w-fit">
                                <p className="text-lg cursor-pointer font-semibold">Socials</p>
                                <a rel="noreferrer" target="_blank" href="https://instagram.com/dlmasset?igshid=YmMyMTA2M2Y=" className="text-lg cursor-pointer">Instagram</a>
                                <a rel="noreferrer" target="_blank" href="https://www.linkedin.com/company/citihomes-finance-company/" className="text-lg cursor-pointer">LinkedIn</a>
                                <a rel="noreferrer" target="_blank" href="https://twitter.com/dlmasset?s=21&t=cBFg4EKCm-TVQKnv_dMVtg" className="text-lg cursor-pointer">Twitter</a>
                                <a rel="noreferrer" target="_blank" href="https://www.facebook.com/DLMAssetManagement?mibextid=LQQJ4d" className="text-lg cursor-pointer">Facebook</a>
                            </div>
                        </div>
                    </div>
