...
const DetailsModal = ({
    ...
    return (
        <Modal2 isCancel cancel={cancel}>
            <div className="max-w-4xl container pb-20 pt-10 flex flex-col gap-y-3">
                {title && (
                ...
                <div className="grid grid-cols-2 gap-x-10 text-sm mt-5 gap-y-5">
                ...
                <div className="grid grid-cols-2 gap-x-10 text-sm mt-10 gap-y-5">
                ...
                {hasTransactions && (
                    <div className="mt-20">
                        ...
                        <div className="h-[500px] overflow-y-auto flex flex-col gap-y-5 pr-5">
                            {/* <Table
                            ...
                            {transactions.map((item: any, index: number) => (
                                <div
                                    className="min-h-[200px] w-full bg-white-lighter shadow-sm border border-primary/10 p-10 grid grid-cols-2 gap-x-20 gap-y-3 text-primary cursor-pointer hover:shadow-md rounded-xl hover:border-primary/20"
                                    onClick={() => reqId(item?.requestId)}
                                    key={index}
                                >
